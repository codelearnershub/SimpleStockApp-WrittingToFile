...
namespace StockMSFile.Models
{
    public class Customer: Person
    {
        ...
        public Customer(string firstName, string lastName, string phone, string address, string email, string id) : this(firstName, lastName, phone, address, email)
        {
            CustomerId = id;
        }
        ...
        {
            return $"{FirstName}\t{LastName}\t{PhoneNumber}\t{Address}\t{Email}\t{CustomerId}";
        }
        ...
        public static Customer ToCustomer(string str)
        {
            ...
            return new Customer(firstName, lastName, phoneNo, address, email, id);
        }
    }
}
